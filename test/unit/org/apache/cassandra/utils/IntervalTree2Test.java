...
public class IntervalTree2Test {
	@Test
	public void testSearch() throws Exception {
		...
		IntervalTree2<Integer, Void, Interval<Integer, Void>> it = IntervalTree2.build(intervals);
		...
		IntervalTree2<Integer, Void, Interval<Integer, Void>> it2 = IntervalTree2.build(intervals2);
	...
	public void testSerialization() throws Exception {
		...
		IntervalTree2<Integer, String, Interval<Integer, String>> it = IntervalTree2.build(intervals);

		IVersionedSerializer<IntervalTree2<Integer, String, Interval<Integer, String>>> serializer = IntervalTree2
		...
		IntervalTree2<Integer, String, Interval<Integer, String>> it2 = serializer.deserialize(in, 0);
